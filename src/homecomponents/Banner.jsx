...
<div class="container">
  ...
  */}
    ...
    <li className='nav-item'> <a className="getstarted  scrollto btn btn-tertiary" target="__blank" href="https://github.com/adityapandeji" > Contact Me </a> </li> 
    </ul> 
