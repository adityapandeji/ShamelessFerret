          ...
          <div className="member" >
            ...
            <div className="member-info">
              ...
              {/* <p>Pursuing my engineering degree in Computer Science. Have Good knowledge of Data Structures & 
                ...
                <a href = "https://www.linkedin.com/in/adityapandeji/"><img src={ld} className="img-fluid" alt="" width = "45vw" height = "45vh"/> </a>
              <a href = "https://github.com/adityapandeji"><img src={gh} className="img-fluid" alt="" width = "40vw" height = "40vh"/>  </a>
              </div> 
                <div>
                  <p> </p>
                </div>
